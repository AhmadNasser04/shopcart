...
function Footer({}: Props) {
  const logo = (
    ...
    >
      <path
        ...
        fill="#003D29"
      />
      <g clipPath="url(#clip0_1107_6023)">
        <path
  ...
  return (
    <div className="flex items-center w-screen py-10 pt-24 justify-evenly">
      <div className="container space-y-10">
        <div className="w-full h-0.5 bg-gray-200" />
        <div className="flex items-center justify-center lg:items-start lg:justify-between">
          <div className="space-y-5 lg:w-1/4">
            <div>{logo}</div>
          ...
          <div className="hidden space-y-7 lg:inline-block">
            <h1 className="text-lg font-semibold">Department</h1>
            <div className="space-y-1">
              {departmentLinks.map((link) => (
                <div key={link.name}>
                  <Link href={link.link}>
                    <p className="transition-all hover:translate-x-2 hover:text-[#ff698e]">
                      {link.name}
                    </p>
                  </Link>
                </div>
